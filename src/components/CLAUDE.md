...
- Proof is a computed contrast ratio from the measured token values (the oklch in
  ...
  default pair was the same drift class, float-correct 17.78. Current values:
  `docs/a11y/inc-242-design-language-proof.md`). The axe gate
...
- Only token pairs: use an existing proven semantic pair (`primary`/`primary-foreground`,
  ...
  `docs/a11y/inc-242-design-language-proof.md`. Any new surface pair is added the same
